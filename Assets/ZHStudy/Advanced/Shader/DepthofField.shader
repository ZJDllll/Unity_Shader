Shader "GT/DepthOfField"
{
        ...
        SubShader
    {
        ...
        float _BokenRadius,_FocusDistance, _FocusRange;
        ...
        {//0
            ...
            half FragmentProgram(Interpolators i) :SV_Target
            {
                ...
                coc = clamp(coc, -1, 1) * _BokenRadius;
                /*if (coc < 0) {
                    return coc * -float4(1, 0, 0, 1);
                }*/
                return coc;
            }
            ENDCG
        ...
        {//1
            ...
            half4 FragmentProgram(Interpolators i) :SV_Target
            {
                ...
                half3 s1 = tex2D(_MainTex,i.uv+o.xw).rgb;
                half3 s2 = tex2D(_MainTex,i.uv+o.zy).rgb;
                ...
                half coc1 = tex2D(_CoCTex,i.uv + o.xw).r;
                half coc2 = tex2D(_CoCTex,i.uv + o.zy).r;
        ...
        {//2
            ...
            half4 FragmentProgram(Interpolators i) :SV_Target
            {
                ...
                for (int k = 0; k < kernelSampleCount;k++) {
                    float2 o = kernel[k] * _BokenRadius;
                    //o *= _MainTex_TexelSize.xy * _BokenRadius;
                    ...
                    //half bgw = Weight(abs(s.a),radius);
                    half bgw = Weigh(max(min(s.a,coc),0),radius);
                    bgColor += s.rgb * bgw;
                    bgWeight += bgw;
